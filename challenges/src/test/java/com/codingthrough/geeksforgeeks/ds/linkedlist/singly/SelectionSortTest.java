...
public class SelectionSortTest extends TestSupport {
    ...
    public void canSortEmptyList() {
        ...
        assertThat(SelectionSort.sort(head), is(nullValue()));
    }

    @Test
    public void canSortOneElementList() {
        Node<Integer> head = buildLinkedList(1);
        assertThat(SelectionSort.sort(head), identicalTo(head));
    }
    ...
    public void canSortTwoElementsUnsortedList() {
        ...
        assertThat(SelectionSort.sort(head), identicalTo(expected));
    }
